...
export const defaultModelResult = {
  ...
  profileInputs: {
    ...
    swingSpeed: 'Medium',
    strokeLength: 'Moderate',
    paceGeneration: 'Neutral',
    topspinLevel: 6,
    launchPreference: 'Neutral shape',
    missPattern: 'Not sure yet',
    courtPositionPreference: 'Baseline',
    swingweightTolerance: 'Balanced',
    fatigueBreakdown: 'No major issue',
    serveImportance: 5,
    powerControlPreference: 'Balanced',
    painArea: 'None',
    painSeverity: 'None',
    stringBreakFrequency: 'Rarely break strings',
    controlMeaning: 'Predictable depth',
    powerMeaning: 'Free depth',
    feelMeaning: 'Connected response',
    spinMeaning: 'More safety margin',
    demoReadiness: 'Show me a ranked shortlist',
    currentRacket: '',
    currentString: '',
    currentTension: '',
    budgetAmount: '',
